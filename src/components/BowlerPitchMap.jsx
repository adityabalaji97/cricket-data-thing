/**
 * BowlerPitchMap Component
 *
 * Wrapper for PitchMapContainer that fetches data from the API
 * and provides filtering options for phase, line, length, and shot.
 * Adapted from PlayerPitchMap.jsx for bowlers.
 */
    ...
    const fetchPitchData = async () => {
      ...
      try {
        const response = await fetch(
          `${config.API_URL}/visualizations/bowler/${encodeURIComponent(playerName)}/pitch-map?${params}`
        );
        ...
        console.error('Error fetching bowler pitch map data:', err);
