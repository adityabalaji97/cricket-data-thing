 ...
 */
const DailyGameShell = ({ game, title, number, rules, stats, finished, resultLine, shareText, children }) => {
  ...
  return (
    <Box sx={{ maxWidth: 560, mx: 'auto', px: { xs: 2, sm: 0 }, py: 2 }}>
      <Box sx={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', gap: 1, mb: 0.5 }}>
        <Typography sx={{ fontFamily: fonts.display, fontWeight: 700, fontSize: 28, color: colors.textHi }}>{title}</Typography>
