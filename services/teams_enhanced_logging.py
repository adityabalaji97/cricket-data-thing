...
def get_team_phase_stats_service_enhanced_logging(
    team_name: str,
    ...
    """
    Get aggregated phase-wise batting statistics for a team with enhanced error logging
    """
    logger.info(f"=== STARTING PHASE STATS SERVICE ===")
    ...
    try:
        ...
        # Step 6: Execute benchmark query
        logger.info("Step 6: Executing benchmark query")
        ...
        try:
            ...
            logger.info(f"Benchmark query executed successfully")
        ...
        logger.info("Step 7: Calculating normalized values")
        ...
        def calculate_percentile(value, p25, p50, p75):
            try:
                ...
                logger.warning(f"Error in calculate_percentile: {e}")
                return 50
        ...
        if benchmark_result and benchmark_result.benchmark_teams > 2:  # Need at least 3 teams for percentiles
            logger.info("Using benchmark-based normalization")
            ...
            try:
                ...
                logger.info("Benchmark-based normalization completed successfully")
                
            except Exception as e:
                logger.error(f"Error in benchmark normalization: {e}")
                logger.error(f"Normalization traceback: {traceback.format_exc()}")
                raise HTTPException(status_code=500, detail=f"Normalization failed: {str(e)}")
                
        else:
            logger.info("Using simple normalization (insufficient benchmark data)")
